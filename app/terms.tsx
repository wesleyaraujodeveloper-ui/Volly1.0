  ...
  return (
    <View style={globalStyles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
          Qualquer texto, foto ou vídeo compartilhado no <Text>Volly Connect</Text> ou no ambiente de Chat é considerado &quot;Conteúdo Gerado pelo Usuário&quot;. Nós da equipe do <Text>Volly App</Text> não nos responsabilizamos pelo teor desse conteúdo..., garantindo o direito aos administradores e líderes da sua própria equipe apagarem ou moderarem o conteúdo inapto à plataforma.
        </Text>
