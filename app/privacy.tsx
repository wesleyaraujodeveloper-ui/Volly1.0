    ...
    <View style={globalStyles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
          ...
          Ao utilizar o <Text>Volly</Text>, você concorda com as práticas descritas neste documento.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          pertence, interações no mural (<Text>Volly Connect</Text>) e mensagens enviadas no chat institucional.
        </Text>
        ...
        <Text style={styles.paragraph}>
          O <Text>Volly</Text> não vende, aluga ou monetiza suas informações pessoais sob nenhuma circunstância. Seus dados são visíveis apenas para:
        </Text>
        <View style={styles.bulletList}>
